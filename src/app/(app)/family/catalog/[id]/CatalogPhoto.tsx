...
import { setIngredientImage } from "../actions";
...
export default function CatalogPhoto({
  ...
  async function handleFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    const path = photoPath(familyId, "catalog", ingredientId, file.name);
    ...
    startTransition(() => setIngredientImage(ingredientId, path));
    setBusy(false);
  }

  function removePhoto() {
    setUrl(null);
    startTransition(() => setIngredientImage(ingredientId, null));
  }
  ...
  return (
    <div>
      ...
      <div className="flex gap-2">
        ...
        >
          {busy ? "Uploading…" : url ? "📷 Replace" : "📷 Add photo"}
        </button>
        {url && !busy && (
          <button
            type="button"
